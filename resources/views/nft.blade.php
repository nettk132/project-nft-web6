        ...
        <div class="nft-container">
            <div class="grid-container">
                ...
                <div class="nft-card">
                    ...
                    <div class="content">
                        <h2>{{ $nft->name }}</h2>
                        <div class="div-creator">
                            <p>{{  $nft->creator}}</p>
                        </div>
                        <p>{{ $nft->catagory_name }}</p>
                        <div class="buttons">
                            <a href="{{ route('nftid', ['id' => $nft->nft_id]) }}" class="btn">รายละเอียด</a>
                            @if ($orderdata->where('nft_id', $nft->nft_id)->where('user_id', auth()->id())->isNotEmpty())
                            <h1>หมด</h1>
                            @else
...
.nft-card {
    ...
    justify-content: space-between; /* จัดวางเนื้อหาและปุ่มในแนวดิ่งและแยกด้วยช่องว่าง */
        height: 100%; /* ให้ความสูงของ .nft-card สูงเท่ากับพื้นที่สูงสุดที่พร้อมใช้งาน */
}
.nft-card img {
    width: 100%;
    height: 100%;
